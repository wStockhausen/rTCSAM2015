...
plotObjFunValues<-function(res,
    ...
    ps$penalties<-plotObjFunValues.Penalties(mdfr,variable=variable,ggtheme=ggtheme,showPlots=showPlots);
    cat("plotting objective function values for priors.\n")
    mdfr<-getObjFunValues.Priors(res);
    ps$priors<-plotObjFunValues.Priors(mdfr,variable=variable,ggtheme=ggtheme,showPlots=showPlots);
    cat("plotting objective function values for data.\n")
    mdfr<-getObjFunValues.Data(res);
    ps$data<-plotObjFunValues.Data(mdfr,variable=variable,ggtheme=ggtheme,showPlots=showPlots);
    return(ps);
}
